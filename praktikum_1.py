...
# Menambahkan hanya satu titik (hasil akhir saja)
c_last, fc_last = data[-1][3], data[-1][4]  # ambil nilai c dan f(c) terakhir
...
# Tambahkan titik-titik c pada setiap iterasi
# for i, (_, a_i, b_i, c_i, fc_i, _) in enumerate(data):
#     plt.plot(c_i, fc_i, 'ro')
#     plt.annotate(f'Iter {i}', (c_i, fc_i), textcoords="offset points", xytext=(0, 5), ha='center', fontsize=8)
